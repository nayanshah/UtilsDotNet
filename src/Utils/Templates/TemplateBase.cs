...
namespace Utils.Templates
{
    public abstract class TemplateBase : ITemplate
    {
        ...
        /// <summary>
        /// Abstract method to validate the template
        /// </summary>
        ...
        public bool Compare(string filePath, IEqualityComparer<string> comparer = null)
        {
            ...
            return comparer.Equals(File.ReadAllText(filePath), Print());
        }
        ...
        #region Auto-generated T4 templates base class
